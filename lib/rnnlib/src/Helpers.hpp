...
#define DUPLICATE(n) for(int DUPLICATE_VAR = 0; DUPLICATE_VAR < (n); ++DUPLICATE_VAR)
//#define FLOAT_REALS
...
//template <class T1, class T2, class T3> struct power: public binary_function<T1, T2, T3>
//{
//	T1 operator()(T2 const& base, T3 const& exponent) const
//	{
//		return pow(base, exponent);
//	}
//};
//template<class T, class R1, class R2> static R1& range_pow(R1& a, const R2& b, const T& exponent)
//{
//	transform(b, a, bind2nd(power<typename range_value<R1>::type, typename range_value<R2>::type, T>(), exponent));
//	return a;
//}
//template<class T, class R> static R& range_pow(R& a, const T& exp)
//{
//	return range_pow(a, a, exp);
//}
