...
struct Rprop: public DataExporter, public Optimiser
{
	...
	//functions
	Rprop(ostream& o, vector<real_t>& weights, vector<real_t>& derivatives, 
			vector<real_t>* plasticities = 0, bool on = false, const string& name = "optimiser"):
		DataExporter(name),
	...
	//TODO implement plasticities here
	void update_weights()
	{
